(() => {
    ...
    const elementosPuntos = document.querySelectorAll('small');
    ...
    elementosPuntos[1].innerText = puntosComputadora;
    ...
    img.classList.add('carta', 'carta-animada');
    // Remover la clase de animación después de que la animación termine
    img.addEventListener('animationend', () => {
    img.classList.remove('carta-animada');
    });
    ...
    elementosPuntos[0].innerText = puntosJugador;
    ...
    puntosJugador = 0;
    puntosComputadora = 0;
    elementosPuntos[0].innerText = '0';
    elementosPuntos[1].innerText = '0';
